...
class CidClassesTest(unittest.TestCase):
    ...
    def test_next_part(self):
        ...
        my_list.add_part("139-456456-01", "BY")
        my_list.add_part("145-789789-00", "CYY")
        ...
        self.assertEqual(my_list.next_rev("139-456456-01").name, "CA")
        self.assertEqual(my_list.next_rev("145-789789-00").name, "DAA")
